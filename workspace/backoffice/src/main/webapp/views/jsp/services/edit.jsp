                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal" id="servicesForm" method="post" action="services/update">
                                      <input class="form-control" id="sid" name="sid" type="hidden" value="${services.sid}" />
