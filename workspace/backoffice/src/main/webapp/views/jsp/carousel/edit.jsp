                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal" id="carouselForm" method="post" action="carousel/update">
                                      <input class="form-control" id="caid" name="caid" type="hidden" value="${carousel.caid}" />
                                      <div class="form-group imageUploadArea">
                                          <label for="cname" class="control-label col-lg-2">展示图片<span class="required">*</span></label>
                                          <div class="col-lg-10">
											  <img id="carouselImg" class="user-image-carousel" src="${carousel.imgUrl}" >
                                              <label>点击图片区域选择上传图片</label>
											  <input id="imgFile" name="imgFile" class="user-image-input" accept="image/*" type="file"/>
											  <input id="imgUrl" name="imgUrl" type="hidden" value="${carousel.imgUrl}"/>
											  <button id="imgUpload" class="btn " type="button">使用新图片</button>
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">展示图名称<span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control" id="name" name="name" value="${carousel.name}" minlength="5" type="text" required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="cemail" class="control-label col-lg-2">链接路径<span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control " id="linkUrl" type="text" name="linkUrl" value="${carousel.linkUrl}" required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="curl" class="control-label col-lg-2">优先级</label>
                                          <div class="col-lg-10">
                                              <input class="form-control " id="priority" type="text" name="priority" value="${carousel.priority}" />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="curl" class="control-label col-lg-2">简单描述</label>
                                          <div class="col-lg-10">
                                              <input class="form-control " id="shortDescription" type="text" name="shortDescription" value="${carousel.shortDescription}" />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="ccomment" class="control-label col-lg-2">展示图描述</label>
                                          <div class="col-lg-10">
                                              <textarea class="form-control " id="description" name="description" required >${carousel.description}</textarea>
                                          </div>
                                      </div>
                                      <div class="form-group">
...
<!--                                               <button class="btn btn-default" type="button">取消</button> -->
  ...
  $(document).ready(function() {
	  ...
	  $.imageUploadControl("carouselImg","imgFile","imgUrl","imgUpload","carousel/uploadImg");
	  
      $("#carouselForm").on("submit", function(){
    	  var form = this;
    	  modalConfirm("是否确认修改信息",function(){
   		   var dataPara = JSON.stringify($("#carouselForm").serializeObject()); 
   		   $.ajax({
   		      url : form.action,
   		      type : form.method,
