...
<head>
                          ...
                          <div class="panel-body">
                              <form id="selectContidionForm" class="form-horizontal " method="get">
                                  <div class="form-group">
                                      <label class="col-sm-1 control-label">展示信息名</label>
                                      <div class="col-sm-2">
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="table-responsive">
                            <table id="carouselTable" class="table">
                              <thead>
                                <tr>
                                  <th>#</th>
                                  <th>ID</th>
  ...
  <script>
	...
	$(document).ready(function() {
		//var vdata = [];
	    var employeeTable = $('#carouselTable').DataTable( {
               ...
               success: function(data) {
              	if(data.statusCode = '20000') {
              		...
              		$.each(dataList, function(i, item){
              			...
              			arrary[0] = (i);
              			arrary[1] = ((dataList[i].caid!=null)?dataList[i].caid:"");

              			var name = ((dataList[i].name!=null)?dataList[i].name:"");
		    			var nameHtml = "<span ";
		    			nameHtml += "caid='"+dataList[i].caid+"' >";
		    			nameHtml += "<a class=\"carousel-name\" href='javascript:void(0);' onclick='detailIfno(this)'";
		    			nameHtml += ">"+name+"</a></span>";
		    			
              			arrary[2] = nameHtml;
              			arrary[3] = ((dataList[i].linkUrl!=null)?dataList[i].linkUrl:"");
              			arrary[4] = ((dataList[i].priority!=null)?dataList[i].priority:"");
              			arrary[5] = ((dataList[i].description!=null)?dataList[i].description:"");
              			tableData[i] = arrary;
              		});
              		employeeTable = $("#carouselTable").dataTable();   
	...
	function detailIfno(which){
		var caid = $(which).parent().attr("caid");
		window.location.href = "carousel/edit?caid=" + caid;
	}
  </script>
